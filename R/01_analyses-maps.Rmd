...
#### ALTERNATIVE 1 harmonieux


proj_transf <- function(x) { 
...
list(land_atolls, land_major, land_minor) %>%
  lapply(proj_transf)


ggplot() +
  geom_sf(data = land_major, fill = col_eez, color = col_eez)
...
for (i in c("Maldives", "Indonesia", "Fiji")) {
