...
ggarrange(map_indicator, plot_donuts, ncol = 1, heights = c(1.2, 0.5))

# 4. Save the plot ----

ggsave(file = "../figs/05_indicators-summary_live-coral-cover.png", dpi = 600)

# 5. Add logo on the plot ----

# 5.1 Load image --

plot <- image_read("../figs/05_indicators-summary_live-coral-cover.png")

# 5.2 Change the background color --

plot <- image_background(plot, "white")

# 5.3 Load the logos --

logo_spatial <- image_read("../figs/00_logo_spatial-extent.png")

logo_temporal <- image_read("../figs/00_logo_temporal-extent.png")

logo_methods <- image_read("../figs/00_logo_methods.png")

logo_taxo <- image_read("../figs/00_logo_taxo.png")

# 5.4 Convert all images to magick objects --

img <- c(plot, logo_spatial, logo_temporal, logo_methods, logo_taxo)

# 5.5 Combine images --

final <- image_composite(plot, logo_spatial, offset = "+927.5+2235", gravity = "northwest")
                
final <- image_composite(final, logo_temporal, offset = "+1700+2235", gravity = "northwest")

final <- image_composite(final, logo_methods, offset = "+2472.5+2235", gravity = "northwest")

final <- image_composite(final, logo_taxo, offset = "+3245+2235", gravity = "northwest")

# 5.6 Save final image --

image_write(final, path = "../figs/05_indicators-summary_live-coral-cover_logo.png", format = "png")
...
map_indicator <- base_ggplot +
  ...
  scale_fill_identity() +
  labs(title = "Other Benthic Groups") +
  theme(plot.title = element_text(hjust = 0.5))
...
plot <- image_read("../figs/05_indicators-summary_other-benthic-groups.png")
...
image_write(final, path = "../figs/05_indicators-summary_other-benthic-groups_logo.png", format = "png")
