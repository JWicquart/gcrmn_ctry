...
# 3. Number of surveys per country ----
...
# 4. Number of observations per country ----
...
# 6. Percentage of observations at the Group level or above ----
...
left_join(nb_sites, nb_surveys) %>% 
  ...
  write_csv2(., "../figs/04_table-monitoring-descriptors-by-country.csv")

# 8. Remove useless objects ----

rm(nb_sites, nb_surveys, nb_obs, data_method, precision_taxo)
