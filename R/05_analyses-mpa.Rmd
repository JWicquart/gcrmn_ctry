...
load("./../data/06_mpa/00-data_mpa_union.RData")

total_mpa <- st_transform(total_mpa, crs = 4326) %>% 
  st_make_valid()

ggplot() +
  geom_sf(data=total_mpa) +
...
mpa_tot_area <- read_csv2("../data/06_mpa/02_mpa-with-reef.csv")
...
top_30 <- unique(total_mpa$SOVEREIGN1)
...
# Import functions, packages and data
>>>>>>> 1fd06b2a8978b248bcc1165adce20b176bd7cdb9
